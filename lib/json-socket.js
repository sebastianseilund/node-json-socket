...
JsonSocket.prototype = {
    ...
    connect: function() {
        //On first connect, save the arguments so we can use them during a reconnect
        if(this._connectArgs === undefined){
            this._connectArgs = arguments;
        }

        this._socket.connect.apply(this._socket, this._connectArgs);
    },
